...
const createSvgIcon = (color, iconType) => {
  ...
  return L.divIcon({
    html: `<div class="custom-marker" style="background-color: #fff; border-radius: 50%; padding: 4px; border: 2.5px solid ${color}; position: relative;">${svgHtml}</div>`,
    className: "",
    iconSize: [40, 48],
    iconAnchor: [20, 40],
    popupAnchor: [0, -40],
    ...
    <div className="incidents-container">
      ...
      <div className="incidents-content">
        ...
        <form onSubmit={handleSubmit} className="incident-form">
          ...
          <div className="form-group coordinates-inputs">
            <input
              type="number"
              name="latitude"
              placeholder="Latitud"
          ...
          <div className="form-group">
            ...
            {selectedLocation && (
              <p className="coordinates-text">
                Coordenadas seleccionadas: {selectedLocation[0].toFixed(6)},{" "}
